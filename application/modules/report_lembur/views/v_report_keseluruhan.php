...
$pdf->SetFont('Arial','B',10);
$pdf->Ln(5);
$pdf->cell(190,8,'Report Keseluruhan',0,1,'C');
$pdf->SetFont('Arial','',8);
$pdf->cell(190,5,'Berisi report lembur keseluruhan pegawai di bulan '.nama_bulan($bulan).' tahun '.$tahun,0,1,'C');
$pdf->Ln(1);
//Table with 20 rows and 4 columns
$pdf->SetWidths(array(10,30,30,30,20,30,40));
$pdf->Ln();
...
$pdf->Output("RLK-".$bulan."-".$tahun.".pdf","I");
