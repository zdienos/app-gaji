...
$pdf->SetFont('Arial','B',10);
$pdf->Ln(5);
$pdf->cell(190,8,'Report Berdasarkan Departemen',0,1,'C');
$pdf->SetFont('Arial','',8);
if($departemen == 1) { $departemen_n = "FA";}
if($departemen == 2) { $departemen_n = "IT";}
if($departemen == 3) { $departemen_n = "PDCA";}
if($departemen == 4) { $departemen_n = "HCS";}
if($departemen == 5) { $departemen_n = "PPI";}
if($departemen == 6) { $departemen_n = "QAQC";}
if($departemen == 7) { $departemen_n = "WAREHOUSE";}
if($departemen == 8) { $departemen_n = "BOF";}
$pdf->cell(190,5,'Berisi report lembur pegawai berdasarkan departemen '.$departemen_n.' di bulan '.nama_bulan($bulan).' tahun '.$tahun,0,1,'C');
$pdf->Ln(1);
//Table with 20 rows and 4 columns
$pdf->SetWidths(array(10,15,25,15,20,25,15,25,40));
$pdf->Ln();
...
$pdf->Output("RBD-".$departemen_n."-".$bulan."-".$tahun.".pdf","I");
